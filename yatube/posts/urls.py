...
urlpatterns = [
    ...
    path('posts/posts_favourite/', views.PostsFavourite.as_view(), name='posts_favourite'),
    path('posts/<int:post_id>/favourite/', views.post_favourite, name='post_favourite'),
    path('posts/<int:post_id>/del_favourite/', views.post_del_favourite, name='post_del_favourite'),
]
